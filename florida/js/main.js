...
$(document).ready(() => {
	$.getJSON("https://kmcelwee.github.io/mediumBlog/floridaman/fm.json", function(data) {
		fm = data;
		$('#man_count').text(`(${fm.count})`)
	});
	$.getJSON("https://kmcelwee.github.io/mediumBlog/floridaman/fw.json", function(data) {
		fw = data;
